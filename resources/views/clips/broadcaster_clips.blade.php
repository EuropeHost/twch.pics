...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-3xl font-bold mb-6 text-center">Clips from {{ $clips->first()->broadcaster_name ?? 'Broadcaster' }}</h1>

    @if ($clips->isEmpty())
    <p class="text-center text-gray-600">No clips found for this broadcaster yet.</p>
    @else
